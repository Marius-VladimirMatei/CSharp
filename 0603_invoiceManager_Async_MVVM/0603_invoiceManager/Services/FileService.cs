...
namespace _0603_invoiceManager_Async_MVVM.Services
{
    ...
    public static class FileService
    {
        ...
        // Asynchronous version: Saves content to a .txt file without blocking UI
        public static async Task<string> SaveAsTxtAsync(string content)
        {
            var filename = Path.Combine(OutputFolder, $"Invoice_{DateTime.Now:yyyyMMdd_HHmmss}.txt");
